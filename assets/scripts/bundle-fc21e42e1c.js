...
function sunrise() {
	...
	if (PT.more[currentDay]) {
		var newImage = '\
			<img src="./assets/graphics/full/' + PT.month[currentDay] + '/f-' + PT.day[currentDay] + 'a.' + PT.imageType[currentDay] + '"></img><img src="./assets/graphics/full/' + PT.month[currentDay] + '/f-' + PT.day[currentDay] + 'b.' + PT.imageType[currentDay] + '" ' + newTransp + '></img>';
	} else {
		var newImage = '\
			<img src="./assets/graphics/full/' + PT.month[currentDay] + '/f-' + PT.day[currentDay] + '.' + PT.imageType[currentDay] + '" ' + newTransp + '></img>';
	}
...
},{}]},{},["/home/travis/build/DylanMoriarty/days-2020/app/assets/scripts/main.js"])
